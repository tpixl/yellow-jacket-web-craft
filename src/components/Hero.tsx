  ...
  return <section id="aperçu" className="relative h-screen flex items-top justify-center overflow-hidden">
      ...
      <div className={`container z-10 mx-0 my-0 ${isMobile ? "py-5 px-2" : "py-20 px-20"}`} style={{
        ...
        <div className="max-w-3xl py-0 px-5" style={{
          ...
          <span className="text-dodge-yellow">Dodge Challenger</span> SRT8<br className="reveal text-5xl md:text-4xl font-bold text-white leading-tight mb-4" />Yellow Jacket
          </h2>
