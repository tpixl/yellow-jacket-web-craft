...
const Hero: React.FC = () => {
  ...
  return <section id="aperçu" className="relative h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 bg-dodge-black">
        ...
        <div className={`absolute inset-0 bg-no-repeat ${isMobile ? "bg-[url('https://i.ibb.co/W47WGKcC/20250501-224529.jpg')] bg-cover bg-center" : "bg-[url('https://i.ibb.co/B2HmsGyK/20240417-203841-HALF.jpg')] bg-contain bg-center"}`} style={{
        width: "1500px",
        /*height: "2000px",*/
        maxWidth: "100%",
        margin: "0 auto"
