...
const Hero: React.FC = () => {
  ...
  return <section id="aperçu" className="relative h-screen flex items-top justify-center overflow-hidden">
      <div className="absolute inset-0 bg-dodge-black">
        ...
        <div className={`absolute inset-0 bg-no-repeat ${isMobile ? /*si mobile :*/"bg-[url('https://i.ibb.co/9m9sTXdF/20240417-203841-HALF.jpg')] bg-cover bg-center" : /*si no mobile*/"bg-[url('https://i.ibb.co/9m9sTXdF/20240417-203841-HALF.jpg')] bg-contain bg-center"}`} style={{
        width: "1500px",
        maxWidth: "100%",
        margin: "0 auto"
      }}></div>
      </div>
      <div className={`container z-10 mx-0 my-0 ${isMobile ? "py-5 px-2" : "py-20 px-20"}`} style={{
        display: "flex",
        /*flexDirection: "row",*/
        justifyContent: "left",
        height: "800px",
        ...
        <div className="max-w-3xl py-0 px-5" style={{
          ...
          <span className="text-dodge-yellow">Dodge Challenger</span> SRT8<br className="reveal text-5xl md:text-7xl font-bold text-white leading-tight mb-4" />Yellow Jacket
          </h2>
